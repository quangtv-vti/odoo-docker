...
``` bash
curl -s https://github.com/quangtv-vti/odoo-docker/master/run.sh | sudo bash -s odoo-one 10016 20016
```
...
``` bash
curl -s https://github.com/quangtv-vti/odoo-docker/master/run.sh | sudo bash -s odoo-two 11016 21016
```
...
``` sh
$ git clone https://github.com/quangtv-vti/odoo-docker
...
* Default database password (**admin_passwd**) is `quangnhung.odoo.com`, please change it @ [etc/odoo.conf#L60](/etc/odoo.conf#L60)
